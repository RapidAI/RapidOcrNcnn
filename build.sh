...
mkdir -p build
pushd build
echo "cmake -DCMAKE_BUILD_TYPE=${BUILD_TYPE} -DOUTPUT_TYPE=${BUILD_OUTPUT} -DOCR_VULKAN=${BUILD_VULKAN} .."
cmake -DCMAKE_INSTALL_PREFIX=install -DCMAKE_BUILD_TYPE=$BUILD_TYPE -DOUTPUT_TYPE=$BUILD_OUTPUT -DOCR_VULKAN=$BUILD_VULKAN ..
